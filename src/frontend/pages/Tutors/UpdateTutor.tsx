...
const UpdateTutor: React.FC = () => {
  ...
  return (
    ...
    <Navbar 
      ...
      buttons={[
        { label: "Registrar", icon: "➕", path: "/RegisterTutor" },
        { label: "Consultar", icon: "🔍", path: "/QueryTutors" },
        { label: "Actualizar", icon: "✏️", path: "/UpdateTutor" },
        { label: "Exportar", icon: "📒", path: "/ExportTutors" }
      ]}
